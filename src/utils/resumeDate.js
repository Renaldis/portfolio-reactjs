let workingHistory = [
  {
    ...
    locType: "Remote",
    description: [
      "Implemented UI designs from Figma using Next.js (App Router)",
      "Built modular and reusable components with shadcn/ui and Tailwind CSS",
      "Used dynamic routing with App Router",
      "Applied responsive design across various screen sizes",
      "Handled form input and validation using React Hook Form and Zod",
    ],
